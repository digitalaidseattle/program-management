...
class MigrationService {
    ...
    //                 .then(() => this.volunteerService.batchInsert(volunteers))
    //         })
    // }
    ...
    //                         team.volunteer_ids
    //                             .map(async vol_id => {
    //                                 const volunteer = await this.volunteerService.findByAirtableId(vol_id);
    //                                 return ({
    //                                     team_id: team.id,
    ...
    //     const volunteers = await this.volunteerService.getAll();
    ...
    //                 const volunteer = r['Volunteer Assigned'] ? await this.volunteerService.findByAirtableId(r['Volunteer Assigned'][0]) : null;
    //                 const supa = ({
    //                     id: uuid(),
    //                     airtable_id: r.id,
