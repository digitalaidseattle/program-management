              ...
              <Stack gap={2}>
                ...
                <Stack gap={2}>
                  ...
                  <FieldRow label="Org shorthand">
                    <Typography color={partner.shorthand_name ? 'text.primary' : 'text.disabled'}>{partner.shorthand_name || '—'}</Typography>
                  </FieldRow>
                </Stack>
              </Stack>
            </Paper>
                  ...
                  {contacts.length ? (
                    <Stack gap={2}>
                      ...
                      <FieldRow label="General phone">
                        <Typography color={partner.general_phone ? 'text.primary' : 'text.disabled'}>{partner.general_phone || '—'}</Typography>
                      </FieldRow>
                    </Stack>
                  ) : (
